...
public class Driver2Profile extends AppCompatActivity {
        ...
        permission.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!permissionManager.checkPermissions(foreground_permission)) {
                    permissionManager.askPermissions(Driver2Profile.this, foreground_permission, 100);
                }
            }
        });
        ...
        Location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!permissionManager.checkPermissions(background_location)) {
                    permissionManager.askPermissions(Driver2Profile.this, background_location, 200);
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (permissionManager.handlePermissionResult(Driver2Profile.this, 100, permissions,
                grantResults)) {
            Log.d("TAG", "1");
            if (locationManager.isLocationEnabled()) {
                startLocationWork();
    ...
    private void startLocationWork() {
        ...
        WorkManager.getInstance(Driver2Profile.this).enqueue(foregroundWorkRequest);
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.logout){
            ...
            editor.clear();
            editor.commit();
            Intent intent = new Intent(Driver2Profile.this, Welcome.class);
            startActivity(intent);
