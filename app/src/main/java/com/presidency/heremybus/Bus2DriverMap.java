...
public class Bus2DriverMap extends FragmentActivity implements OnMapReadyCallback, LocationListener {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    try {
                        ...
                        Toast.makeText(Bus2DriverMap.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
